...
public class IRcommand_Binop_Div_Integers extends IRcommand
{
	...
	public void MIPSme()
	{
        ...
        /*      if (t1_div_t2 < -32768) goto label_overflow;   */
		/*     if (32767 >= t1_div_t2 && t1_div_t2 >= -32768)*/ 
		/*			goto label_no_overflow;                      */
		/*********************************************************/
		sir_MIPS_a_lot.getInstance().blt(intMax,t1_div_t2,label_overflow_pos);
		sir_MIPS_a_lot.getInstance().blt(t1_div_t2,intMin,label_overflow_neg);
